        ...
        <SimpleGrid columns={{ md: 2, sm: 1 }} m={4} spacing={8}>
          <Card>
            <CardBody>
              ...
              {image && <Image alt="" src={image} mt={4} w={325} h={406} objectFit="cover" />}
            </CardBody>
          </Card>
          <Card>
            <CardBody>
                  ...
                  <div id="canvas-pdam" style={{ position: "relative", width: 340 }}>
                    ...
                    >
                      <Text
                        ...
                        fontWeight={400}
                        color="white"
                        textAlign="center" // pastikan tidak wrap
                      >
                        {data?.tanggal}
                      </Text>
                    </Box>
                    ...
                    >
                      <Text className={poppins.className} fontSize={12} fontWeight={500}>
                        {data?.informasi_gangguan}
                      </Text>
                    </Box>
                  </div>
                  <Button colorScheme="teal" onClick={() => download(`canvas-pdam`, createFileName())} size="sm" mt={4}>
                    Download
                  </Button>
                    ...
                    return (
                      <div key={index} style={{ marginBottom: 40, marginTop: 40 }}>
                        <div id={`canvas-pdam${index}`} style={{ position: "relative", width: 340 }}>
                          ...
                          >
                            <Text className={poppins.className} fontSize={11} fontWeight={500}>
