          ...
          <Card>
            <CardBody>
              ...
              <Flex justify="space-between">
                ...
                <Button colorScheme="teal" onClick={downloadAll} size="sm">
                  Download All
                </Button>
              </Flex>
              <div style={{ marginBottom: 40, marginTop: 40 }}>
                <div id={`headline`} style={{ position: "relative", width: 340 }}>
                  <Image src={"/images/PLN-MAIN.jpg"} w={340} fit="cover" alt="media" />
                  <Box
                    style={{
                      position: "absolute",
                      top: 212,
                    ...
                    py={1}
                  >
                    <Text color={"white"} className={poppins.className} fontWeight={500}>
                      {tanggal}
                    </Text>
                  </Box>
                </div>
                <Button colorScheme="teal" onClick={() => download(`headline`, createFileName())} size="sm" mt={4}>
                  Download
                </Button>
              </div>
              ...
              {chunkedData.map((chunk, idx) => (
                <div key={idx} style={{ marginBottom: 40, marginTop: 40 }}>
                  <div id={`canvas${idx}`} style={{ position: "relative", width: 340 }}>
                    ...
                    >
                      <Text color={"#fff"} className={poppins.className} fontSize={14}>
                        {tanggal}
                      </Text>
                    </Box>
